...
export const updateProfileSchema = z.object({
  ...
  customStyles: z.object({
    ...
    cardBg: z.string().optional().nullable(),
...
export const pricingPlans = pgTable("pricing_plans", {
  ...
  monthlyPriceUsd: numeric("monthly_price_usd", { precision: 10, scale: 2 }).notNull().default("0"),
  yearlyPriceUsd: numeric("yearly_price_usd", { precision: 10, scale: 2 }).notNull().default("0"),
  ...
  isLtd: boolean("is_ltd").notNull().default(false),
  themeCategories: jsonb("theme_categories").notNull().default(["starter", "professional", "creative", "premium"]),
...
export const createPricingPlanSchema = z.object({
  ...
  monthlyPriceUsd: z.number().min(0).default(0),
...
export const updatePricingPlanSchema = z.object({
  ...
  themeCategories: z.array(z.string()).optional(),
